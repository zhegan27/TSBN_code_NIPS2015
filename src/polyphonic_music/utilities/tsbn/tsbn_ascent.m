function [parameters,result]=tsbn_ascent(v,parameters,opts,vtest)
...
for iter=1:opts.iters
    ...
    if mod(iter,opts.evalInterval)==0
        ...
        %predErr_test = [predErr_test;tmp3]; 
        totaltime = toc;
        fprintf('Test, Iter %d: logpv=%4.8f, time=%4.8f\n',...
            iter,logpv_test(end),totaltime);
    end
end
